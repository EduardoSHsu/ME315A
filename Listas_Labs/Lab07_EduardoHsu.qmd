...
O professor considerado mais fácil, ou seja, com maior gpa médio é um empate
entre YAJUAN SI, SRIKANTHMADHAVAN ARAVAMUTHAN e GUANHUA CHEN.

Qual é a disciplina mais difícil? 

A disciplina considerada mais difícil, isto é, com menor gpa médio é Introduction 
to the Theory of Probability

Qual é a disciplina mais fácil?

A disciplina considerada mais fácil, isto é com maior gpa médio é um empate 
entre Data Science Practicum, Empir Proc&Semiparmtrc Infernc, Nonparametric
Statistics and Machine Learning Methods e Sample Survey Theory and Method.
